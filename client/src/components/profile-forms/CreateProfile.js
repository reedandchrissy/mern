    ...
    return(
        ...
        <form className="form" onSubmit={e=>onSubmit(e)}>
            ...
            <small className="form-text"
                >Give us an idea of where you are at in your academia</small
            >
            </div>
            <div className="form-group">
            <input type="text" placeholder="University" name="university" value = {university} onChange={(e)=> onChange(e)}/>
            <small className="form-text"
                >Current school you are currently enrolled in</small
            >
            </div>
            <div className="form-group">
            <input type="text" placeholder="Website" name="website" value = {website} onChange={(e)=> onChange(e)}/>
            <small className="form-text"
                >Could be your own or a school website</small
            >
            </div>
            <div className="form-group">
